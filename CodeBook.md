...
Description of this data could be found here:

http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones

Data set could be accquired here:
...
The run_analysis.R will implement the clean up with following steps:

1. load needed packages: dplyr and reshape2
2. load data
3. load activity and feature names
4. rename variable with appropriate name
